...
python -m torch.distributed.launch \
	...
	--n_epoch $EPOCH \
        ...
        --freeze_pos_embs \
        --dump_path /logs/distilbert/$FILENAME.init-rms-1M-1-012345_label-rms-1M-1-original_ce-loss-1_roberta \
        --data_file $BASE_DIR/binarized_$FILENAME.roberta-med-small-1M-1.pickle \
        --token_counts $BASE_DIR/token_counts.roberta-med-small-1M-1.pickle \
        --checkpoint_epoch_interval 1 \
        --student_pretrained_weights /logs/weight_initialization/rms-1M-1_012345.pth \
